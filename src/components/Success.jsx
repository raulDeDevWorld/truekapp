...
import { useUser } from '@/context/Context.js'
 ...
 function Button({children}) {
    ...
    return (
        <div class="fixed top-0 left-0 w-screen flex p-4 mb-4 text-sm text-green-800 border border-green-400 rounded-lg bg-gray-50 lg:py-8 z-50" role="alert" onClick={()=>setUserSuccess('')}>
            ...
            <div class="text-[14px]">
                <span class="font-medium text-[14px]">Exitoso! </span>{children}
            </div>
        </div>
    )
}
